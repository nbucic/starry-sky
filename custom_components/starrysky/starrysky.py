...
TURN_ON_CMD = [[0xa5, 0xff, 0x01, 0x0c, 0x05, 0x00, 0x00, 0x00, 0xff, 0x0b, 0x00, 0x12, 0x05, 0xff, 0x04, 0xff, 0x01, 0x05, 0x00, 0xaa]]
TURN_OFF_CMD = [[0xa5, 0x00, 0x01, 0x0c, 0x05, 0x00, 0x00, 0x00, 0xff, 0x0b, 0x00, 0x12, 0x05, 0xff, 0x04, 0xff, 0x01, 0x05, 0x00, 0xaa]]
...
class BLEDOMInstance:
    ...
    async def set_color(self, rgb: Tuple[int, int, int]):
        r, g, b = rgb
        await self._write([0xa5, 0xff, 0x01, 0x0c, 0x05, r, g, b, 0x00, 0x0b, 0x00, 0x12, 0x05, 0xff, 0x04, 0xff, 0x01, 0x05, 0x00, 0xaa])
    ...
    async def set_white(self, intensity: int):
        await self._write([0xa5, 0xff, 0x01, 0x0c, 0x05, 0x00, 0x00, 0x00, 0xff, 0x0b, 0x00, 0x12, 0x05, 0xff, 0x04, 0xff, 0x01, 0x05, 0x00, 0xaa])
    ...
    async def set_brightness(self, intensity: int):
        await self._write([0xa5, 0xff, 0x01, 0x0c, 0x05, 0x00, 0x00, 0x00, 0xff, int(intensity*100/255), 0x00, 0x12, 0x05, 0xff, 0x04, 0xff, 0x01, 0x05, 0x00, 0xaa])
